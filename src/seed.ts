...
/** Build a Lexical bullet list node. */
...
/** Build a Lexical paragraph node. */
...
/** Build a Lexical rich-text document from mixed nodes (paragraphs, lists, etc). */
function makeRichTextFromNodes(...nodes: Record<string, unknown>[]) {
  return {
    root: {
      type: 'root',
      direction: 'ltr' as const,
      ...
      indent: 0,
      version: 1,
      children: nodes as ReturnType<typeof makeRichText>['root']['children'],
    },
  }
}
