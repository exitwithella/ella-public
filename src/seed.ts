...
async function seed() {
  ...
  const disciplines = [
    ...
    },
    {
      ...
      description:
        "Integrated wealth planning for high-net-worth individuals and families.",
      sortOrder: 2,
    },
    {
      ...
      description:
        "Strategic advisory services for closely held business owners.",
      sortOrder: 3,
    },
    {
      ...
      description:
        "Coordinated tax and estate planning to preserve and transfer wealth.",
      sortOrder: 4,
    },
  ];
  ...
  const homepageLayout = [
    ...
    // Block 7: Comparison Table — Old Way / Patchwork / With ELLA (Option D)
    {
      ...
      subheading:
        "See how ELLA compares to the workflows advisors are trying to leave behind.",
      bgStyle: "cream",
      columns: [
        {
          heading: "The Old Way",
