...
type FeatureRow = {
  label: string
  practitioner: { indicator?: 'check' | 'cross' | 'partial' | 'text'; text?: string }
  enterprise: { indicator?: 'check' | 'cross' | 'partial' | 'text'; text?: string }
}
    ...
    <section className="bg-ash-50 py-24 md:py-32">
      <Container>
        ...
        <div className="mx-auto max-w-lg space-y-6 md:hidden">
          ...
          {/* Enterprise card */}
          <div className="border-ash-200 bg-ash-50 rounded-sm border p-5">
