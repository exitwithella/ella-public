...
function StepRow({
  ...
  const bgColor = useTransform(locked, (l) => (l ? OCEAN_700 : 'var(--color-sandstone-50)'))
    ...
    >
      ...
      >
        <span style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
          <span style={{ color: ASH_200, fontSize: '0.75rem', fontWeight: 700 }}>✕</span>
          {row.old}
        </span>
      </motion.div>
      ...
      <motion.div
        ...
        style={{
          ...
          borderLeft:
            showRigid && !defeated ? `2px solid ${ca(OCEAN_700, 0.21)}` : '2px solid rgba(0,0,0,0)',
        }}
        transition={SPRING_DEFAULT}
      >
        <span style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>
      ...
      <motion.div
        ...
        style={{
          ...
          borderLeft:
            showPatch && !defeated ? `2px solid ${ca(GOLDENROD, 0.27)}` : '2px solid rgba(0,0,0,0)',
        }}
        transition={SPRING_DEFAULT}
      >
        <span style={{ display: 'flex', alignItems: 'center', gap: '5px' }}>{row.patch}</span>
      </motion.div>
      ...
      <motion.div
        ...
        style={{
          ...
          position: 'relative',
          overflow: 'hidden',
          borderLeft: ellaIn ? `3px solid ${MOSS_400}` : '3px solid rgba(0,0,0,0)',
        }}
      >
        <AnimatePresence>
          {ellaIn && (
    ...
    >
      ...
      >
        ...
        <motion.div
          ...
          initial="hidden"
          animate={showPatch ? 'visible' : 'hidden'}
          style={optionStyle(ca(GOLDENROD_100, 0.38), GOLDENROD_700, GOLDENROD, defeated)}
        >
          <div
            style={{
              fontSize: '0.5625rem',
        ...
        >
          {isMobile ? (
            ...
            >
              ...
              >
                ...
                <motion.div
                  ...
                  style={{
                    ...
                    overflow: 'hidden',
                    borderLeft:
                      tablePhase >= 4 ? `3px solid ${MOSS_400}` : '3px solid rgba(0,0,0,0)',
                  }}
                >
                  <AnimatePresence>
                    {tablePhase >= 4 && (
              ...
              {/* Table rows */}
              {resolvedTableRows.map((row, i) => (
                <TRow key={i} row={row} index={i} phase={tablePhase} scanReached={scanReached[i]} />
              ))}
            </div>
          )}
