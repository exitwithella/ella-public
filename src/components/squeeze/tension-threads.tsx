    ...
    const draw = (timestamp: number) => {
      ...
      for (const thread of threads) {
        ...
        if (thread.hasSnapped) {
          ...
          // Snapped halves — goldenrod-800 equivalent (RGB: 100, 82, 50)
          // Left half
          ctx.beginPath()
          ctx.strokeStyle = `rgba(100, 82, 50, ${thread.opacity * (1 - thread.snapProgress * 0.6)})`
          ...
          // Intact threads: moss-600 equivalent (85, 110, 75) -> goldenrod-700 (125, 85, 60)
          ctx.beginPath()

          const r = Math.round(85 + tension * 40)
          const g = Math.round(110 + tension * -25)
          const b = Math.round(75 + tension * -15)
