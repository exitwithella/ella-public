...
export const AllVariants: Story = {
  ...
  render: () => (
    <div className="flex flex-col gap-8 p-10">
      <div>
        <p className="text-theme-text-muted mb-3 text-xs tracking-wider uppercase">
          Colors (xs size)
        </p>
        <div className="flex flex-col gap-2">
          ...
          <div className="bg-ash-900 rounded p-3">
            <Eyebrow color="light">Light</Eyebrow>
          </div>
        </div>
      </div>
      <div>
        <p className="text-theme-text-muted mb-3 text-xs tracking-wider uppercase">Sizes</p>
        <div className="flex flex-col gap-2">
