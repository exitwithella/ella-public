  ...
  render: () => (
    ...
    >
      <Testimonial
        quote={
          <p>
            ELLA transformed how we handle client transitions. What used to take weeks now takes
            days.
          </p>
        }
        img={placeholder}
      ...
      <Testimonial
        quote={
          <p>
            Finally, a platform that understands the nuance of advisory relationships — not just the
            transactions.
          </p>
        }
        img={placeholder}
      ...
      <Testimonial
        quote={
          <p>
            We went from scattered spreadsheets to a single source of truth. Our team is more
            confident and our clients notice.
          </p>
        }
        img={placeholder}
        name="Rebecca Torres"
